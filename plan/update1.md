...
```
Phase 9 (Supabase + Auth)        ████████░░░░░░░░░░░░░░░░░░  [Tuần 1] ← Nền tảng trước
...
**Thứ tự**: Phase 9 → 1+8 → 2 → 4 → 3 → 7 → 5 → 6

> Phase 9 làm **đầu tiên** vì là nền tảng lưu trữ + auth cho tất cả phase sau.
...
| 8 | Thứ tự | ✅ Phase 9 → 1+8 → 2 → 4 → 3 → 7 → 5 → 6 |
